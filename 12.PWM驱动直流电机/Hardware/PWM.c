...
void PWM1_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1;//PA0:Tim_CH1和PA1:Tim_CH2
...
void PWM2_Init(void)
{
	...
	GPIO_Initstructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_0;//PB0:Tim3_CH3和PB1:Tim_CH4
	GPIO_Initstructure.GPIO_Speed = GPIO_Speed_50MHz;
	...
	TIM_TimeBaseInitStruct.TIM_Prescaler = 36-1;//PSC 预分频几个72Mhz计数1
